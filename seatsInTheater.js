...
since the exit is located right behind your row to the left. All you 
need to do is climb over your seat and make your way to the exit.
...
to the left, assuming all seats are occupied.
...
function f(nCols, nRows, col, row) {

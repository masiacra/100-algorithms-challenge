...
//его разбора бы не разобрался. Тут не хватает тестовых данных.
...
//p.s. Меня смутила в формулировке слово smaller. Почему то подумал, что
//надо найти наименьшее предыдущее значение.

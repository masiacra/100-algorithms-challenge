...
function f(a) {
	...
	function aux(num) {
		return num.toString().split('').reduce( (composition, dig) => {
			dig = parseInt(dig);
			return composition * dig;
		}, 1);
	}
	
}
//Dylan Israel  вместо цикла map использует forEach и сразу смотрит, содержит
//результирующий массив product конкретного значения исходного массива

...
it('Проверка для задачи arrayChange', () => {
	it('Для массива [1,1,1] ответ 3', () => {
		assert.equal(exc13.f([1,1,1]), 3);
	});
	
	it('Для массива [9, 6, 5, 1] ответ 32', () => {
		assert.equal(exc13.f([9,6,5,1]), 32);
	});
	it('Для массива [9,10,13,9] ответ 5', () => {
...
it('Проверка для задачи arrayMaxConsecutiveSum', () => {
	it('Для массива [2, 3, 5, 1, 6] и k = 2 ответ 8', () => {
		assert.equal(exc15.f([2, 3, 5, 1, 6], 2), 8);
	});
	it('Для массива [2, 3, 5, 1, 6] и k = 3 ответ 12', () => {
		assert.equal(exc15.f([2, 3, 5, 1, 6], 3), 12);
	});	 
	it('Для массива [2, 3, 5, 1, 6] и k = 4 ответ 15', () => {
		assert.equal(exc15.f([2, 3, 5, 1, 6], 2), 15);
	});
	it('Для массива [2, 3, 5, 1, 6] и k = 5 ответ 15', () => {
		assert.equal(exc15.f([2, 3, 5, 1, 6], 2), 17);
	});
});
